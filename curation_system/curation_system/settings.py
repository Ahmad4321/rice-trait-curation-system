"""
Django settings for curation_system project.
...
SECRET_KEY = 'django-insecure-y$v3oj@-u8j)t(%98bm$&eh5*=f)9&2=pk2osc+&*@6m%6mfgh'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'curation_system_frontend/build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'curation_system.wsgi.application'
